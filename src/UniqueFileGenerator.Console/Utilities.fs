...
module Utilities =
    ...
    type Num =
        ...
        static member Format(i: int)   : string = i.ToString("#,##0", culture)
        static member Format(i: int64) : string = i.ToString("#,##0", culture)
        static member Format(f: float) : string = f.ToString("#,##0.00", culture)
